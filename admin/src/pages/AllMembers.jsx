            ...
            {modalType === "view" && selectedMember && (
              <>
                ...
                <div className="space-y-5">
                  {/* Inside View Modal - Large Avatar */}
                  <div className="flex justify-center mb-6">
                    <div className="w-32 h-32 rounded-full overflow-hidden shadow-2xl border-4 border-white">
                      {selectedMember.avatar ? (
                        ...
                        <div className="w-full h-full bg-[#e3002a] text-white flex items-center justify-center font-bold text-5xl">
                  ...
                  <div>
                    ...
                    <span className={`inline-flex mt-1 ml-3 px-4 py-2 rounded-full text-sm font-medium border ${getStatusColor(selectedMember.membership)}`}>
