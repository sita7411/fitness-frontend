...
const Nutrition = () => {
  ...
  const filteredTips = nutritionTips.filter((tip) => {
    ...
    if (filter === "inactive") return tip.status === "Inactive";
    return true; // all
  });
    ...
    <div className="min-h-screen mb-30">
      ...
      <section className="relative h-[90vh] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center mt-16 max-w-3xl px-6">
          ...
          >
            Access {nutritionTips.length} Expert-Curated Nutrition Plans
            Designed to Help You Achieve Optimal Health
          </motion.p>
          <motion.div
      ...
      {/* Cards */}
      <div id="nutrition" className="grid gap-10 mb-10 mx-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-6">
              ...
              <motion.button
                ...
                className="w-full py-4 rounded-xl font-bold text-xl shadow-lg transition-all duration-300 bg-[#E3002A] hover:bg-red-700 text-white"
              >
                Add to Cart
              </motion.button>
