// src/components/Navbar.jsx (Admin Panel)
import React, { useRef, useState, useEffect } from "react";
import { Search, Mail, Bell, Settings, Shield, LogOut, Trash2 } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { useAdminAuth } from "../context/AdminAuthContext";
import axios from "axios";
import { getSocket } from "../utils/socket"; // admin/src/utils/socket.js
...
export default function Navbar({ hideNavbar = false }) {
  ...
  // Admin Notifications - Fetch + Real-time
  useEffect(() => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={notificationsRef}>
          <button
            ...
            className="relative w-10 h-10 bg-white shadow-sm rounded-xl flex items-center justify-center hover:bg-[#e3002a]/10 transition"
            title="Notifications"
          >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900">
                          {notif.title || "Admin Notification"}
                        </p>
                        {notif.message && (
