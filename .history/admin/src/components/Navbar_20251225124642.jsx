// src/components/Navbar.jsx (Admin version - updated)
import React, { useRef, useState, useEffect } from "react";
import { Search, Mail, Settings, Shield, LogOut, Bell, Trash2 } from "lucide-react";
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative w-10 h-10 bg-white shadow-sm rounded-xl flex items-center justify-center hover:bg-red-50 hover:text-red-600 transition"
          >
              ...
              <div className="max-h-80 overflow-y-auto">
                {notifications.length === 0 ? (
                  ...
                  notifications.map((notif) => {
                    const Icon = notif.icon === "workout"
                      ? require("lucide-react").Dumbbell
                      : notif.type === "success"
                      ? require("lucide-react").CheckCircle
                      : notif.type === "error"
                      ? require("lucide-react").AlertTriangle
