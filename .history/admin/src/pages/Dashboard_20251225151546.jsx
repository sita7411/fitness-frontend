...
>
  ...
  <div className="relative z-10 flex items-center gap-5">
    {/* Profile Avatar with Icon Overlay (optional trophy badge) */}
    <div className="relative flex-shrink-0">
      <div className="w-20 h-20 rounded-full overflow-hidden shadow-xl border-4 border-white/40">
        <img
      ...
      {/* Small Trophy Icon on Avatar (corner badge) */}
      <div className="absolute -bottom-1 -right-1 bg-yellow-400 text-white rounded-full p-2 shadow-lg">
        <Award size={20} />
      </div>
    </div>
