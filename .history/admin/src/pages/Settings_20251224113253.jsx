...
export default function AdminSettingsProfessional() {
  ...
  const handleLogoChange = (e) => {
    ...
    if (file) {
      ...
      toast.info("Logo selected – click Save to upload");
    }
  };
        ...
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100">
          <form onSubmit={handleSubmit} className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-6">
                ...
                {floatingIcons.map((icon, idx) => (
                  ...
                  >
                    ...
                    <Input
                      ...
                      step="0.1"
                      onChange={(e) =>
                        updateIcon(idx, "delay", parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                ))}
              ...
              {floatingIcons.length === 0 && (
                <p className="text-center text-gray-500 py-6">
                  No floating icons yet. Click "+ Add Icon" to start.
                </p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={saving}
              className="bg-[#e3002a] hover:bg-[#c10025] disabled:opacity-70 disabled:cursor-not-allowed text-white font-semibold py-3 px-8 rounded-lg shadow-md w-fit transition"
            >
