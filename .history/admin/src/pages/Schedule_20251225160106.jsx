...
export default function AdminSchedule() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      console.log("📅 Fetching events for:", format(currentMonth, "MMMM yyyy"));
      ...
      try {
        ...
        console.log("✅ Events fetched successfully:", res.data.events?.length || 0);
        setEvents(res.data.events || []);
      } catch (err) {
        // 🛑 यह जरूर दिखेगा अगर 403 आए
    ...
    // केवल तब fetch करो जब admin logged in हो
    if (!loading && admin) {
      fetchEvents();
    }
  }, [currentMonth, selectedUser, admin, loading]);
