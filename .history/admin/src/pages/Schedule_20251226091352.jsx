...
export default function AdminSchedule() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      if (!admin) return; // Don't fetch if not logged in
    ...
    fetchEvents();
  }, [currentMonth, selectedUser, admin, api]);
  ...
  const eventsByDate = useMemo(() => {
    ...
    events.forEach((ev) => {
      ...
      const shouldInclude = selectedUser === null || eventUserId === selectedUser;
          ...
          >
            ...
            >
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  onClick={handleSave}
                  className="px-6 py-2 bg-gradient-to-r from-[#e3002a] to-pink-600 text-white rounded-lg shadow-md hover