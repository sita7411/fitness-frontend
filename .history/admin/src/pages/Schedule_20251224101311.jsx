...
const EventCard = ({ ev, onClick }) => {
  // FIX: displayUserName use karo jo eventsByDate mein calculate kiya hai
...
export default function AdminSchedule() {
    ...
    try {
      ...
      if (res.data.success) {
        const normalized = res.data.users.map((u) => ({
          ...u,
          _id: u.id, // FIX: admin/users API mein 'id' field hota hai, usko _id bana do
        }));
  ...
  // FIX: eventsByDate logic ko sahi kiya + allUsers dependency add ki
  const eventsByDate = useMemo(() => {
    ...
    // Sort events by startTime for each date
