...
export default function PaymentsPage() {
    ...
    const fetchTransactions = async () => {
        setLoading(true);
        try {
            const res = await axiosAdmin.get("/revenue/transactions?limit=50");
    ...
    const fetchMemberships = async () => {
        setLoading(true);
        try {
            const res = await axiosAdmin.get("/revenue/membership/users?limit=50");
            ...
            console.error("Memberships error:", err.response?.data || err);
    ...
    const fetchRevenuePerformance = async () => {
        setLoading(true);
        try {
            const res = await axiosAdmin.get("/revenue/performance?period=monthly");
            ...
            try {
                const weeklyRes = await axiosAdmin.get("/revenue/last-7-days");
