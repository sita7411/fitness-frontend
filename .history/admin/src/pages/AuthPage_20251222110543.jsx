// /admin/src/pages/AuthPage.jsx → FINAL PRODUCTION VERSION (December 22, 2025)
...
export default function AuthPage() {
  ...
  // Agar already logged in hai toh direct dashboard bhejo
  useEffect(() => {
    if (isLoggedIn) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <motion.div
        ...
        className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200"
      >
        {/* Logo Section */}
