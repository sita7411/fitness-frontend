...
export default function PaymentsPage() {
    ...
    const fetchRevenuePerformance = async () => {
        setLoading(true);
        try {
            const res = await axiosAdmin.get("/api/revenue/performance?period=monthly");
            ...
            try {
const weeklyRes = await axiosAdmin.get("/api/revenue/last-7-days");                const days = weeklyRes.data.days;
