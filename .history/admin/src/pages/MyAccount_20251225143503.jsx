...
const apiCall = async (endpoint, options = {}) => {
  ...
  // Decide base path based on method and endpoint
  if (endpoint === "/me") {
    if (options.method === "PUT") {
      fullEndpoint = "/me"; // Profile update → user route (no /admin)
    } else {
      fullEndpoint = "/admin/me"; // GET → admin route (protected by adminprotect)
    }
  } else if (endpoint === "/password") {
    fullEndpoint = "/password"; // Password change → user route
  } else if (endpoint === "/logout") {
    fullEndpoint = "/admin/logout"; // Logout → admin route
  } else {
