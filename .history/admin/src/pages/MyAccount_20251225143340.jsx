...
const apiCall = async (endpoint, options = {}) => {
  ...
  // Special case: Profile update aur password change ke liye /admin nahi lagana
  if (endpoint === "/me" && options.method === "PUT") {
    fullEndpoint = "/me"; // /admin/me ki jagah /me
  } else if (endpoint === "/password") {
    fullEndpoint = "/password"; // /admin/password ki jagah /password
  } else {
