...
export default function AdminNotifications() {
  ...
  useEffect(() => {
    ...
    if (!admin?._id) {
      console.log("⚠️ Admin object loaded but _id missing – possible context issue");
      // Force fetch anyway if logged in (temporary fallback)
      fetchNotifications();
      return;
    }

    console.log("✅ All conditions passed – Admin ID:", admin._id);
    fetchNotifications();
    ...
    console.log("Registered socket as admin:", admin._id);
