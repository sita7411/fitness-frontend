...
import { sendNotification } from "../services/notificationService.js"; // ← ये import add कर लें अगर नहीं है
...
export const createScheduleEvent = async (req, res) => {
  try {
    ...
    // Rule:
    // - Admin किसी के लिए भी create कर सकता है
    // - Member सिर्फ खुद के लिए और सिर्फ "manual" source का event create कर सकता है
