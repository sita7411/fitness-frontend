...
export const markMealComplete = async (req, res) => {
  try {
    ...
    console.log("markMealComplete called:", { mealId, planId, dayIndex, userId });

    // String comparison karo (sabse safe aur reliable)
    const updatedUser = await User.findOneAndUpdate(
      {
        _id: userId,
        "nutritionProgress.planId": planId, // ← String se compare
      },
      {
        $addToSet: {
          "nutritionProgress.$.completedMeals": {
            mealId: mealId,           // ← String hi rakho
