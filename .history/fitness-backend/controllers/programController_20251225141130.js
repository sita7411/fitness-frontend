...
export const completeProgramDay = async (req, res) => {
  try {
    ...
    // ====== STREAK CALCULATION ======
    // ====== STREAK CALCULATION ======  (पुराना block हटाकर यह नया डालो)
let currentStreak = 0;
if (isNewCompletion || alreadyCompletedToday) {
  ...
  const uniqueDates = [...new Set(userCompletions)]
...
// ====== USER NOTIFICATIONS ======
  ...
  const shortName = userFirstName.charAt(0).toUpperCase() + userFirstName.slice(1).toLowerCase();
