...
const transformFrontendToBackend = (
  ...
  const existingThumbnail = data.thumbnail && typeof data.thumbnail === "object" 
  ...
  const daysWithThumbnails = (data.days || []).map((day, dayIndex) => ({
    ...
    exercises: (day.exercises || []).map((ex, exIndex) => {
      ...
      // Old thumbnail fallback (edit में पुराना रहना चाहिए अगर नया न upload हो)
      const oldThumb = ex.thumbnail && typeof ex.thumbnail === "object" 
