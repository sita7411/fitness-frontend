...
export const login = async (req, res) => {
  try {
    ...
    res.setHeader("Set-Cookie", [
      cookie.serialize("user_jwt ", token, userCookieOptions),
      cookie.serialize("admin_jwt", "", clearAdminCookie), // Clear admin session
    ]);
...
export const adminLogin = async (req, res) => {
  try {
    ...
    res.setHeader("Set-Cookie", [
      cookie.serialize("admin_jwt", token, adminCookieOptions),
      cookie.serialize("user_jwt", "", clearUserCookie), // Clear user session
    ]);
...
export const logout = async (req, res) => {
  try {
    res.setHeader("Set-Cookie", [
      cookie.serialize("user_jwt", "", clearUserCookie),
      cookie.serialize("admin_jwt", "", clearAdminCookie),
    ]);
