...
export const getLatestWorkoutSession = async (req, res) => {
  try {
    ...
    res.json({
      ...
      date: formattedDate,
      thumbnail,
      weight: recordedWeight, // Now reliably shows weight
    });
  } catch (e) {
