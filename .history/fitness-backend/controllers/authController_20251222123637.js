...
// ========================
// COOKIE OPTIONS - SHARED PATH (ROOT) - RECOMMENDED FIX
// ========================
...
// दोनों cookies का path same कर दो → "/" (root)
...
// Clear cookies (path same होने से clearing 100% काम करेगा)
...
export const signup = async (req, res) => {
  try {
    ...
    res.setHeader("Set-Cookie", [
      ...
      cookie.serialize("admin_token", "", clearAdminCookie), // admin session clear
    ]);
