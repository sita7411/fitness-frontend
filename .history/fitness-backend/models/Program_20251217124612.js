    ...
    completedBy: [
      {
        ...
        exerciseId: { type: String, required: true },              // Exercise.id (string from frontend)
...
// Optional: Compound index for fast queries (user + program + date)
ProgramSchema.index({ "completedBy.user": 1, "completedBy.completedAt": -1 });
// Index for finding user's completions in a program
