...
import { v4 as uuidv4 } from "uuid"; // npm install uuid अगर नहीं है

const ExerciseSchema = new mongoose.Schema(
  {
    // पुराने data में id नहीं था → अब optional + default UUID
    id: {
      type: String,
      required: false,
      default: () => uuidv4(), // missing हो तो auto generate
    },
  ...
  { _id: false } // manual id use कर रहे हैं, auto _id नहीं चाहिए
);

const DaySchema = new mongoose.Schema(
  {
    // पुराने data में day missing हो सकता है
    day: {
      type: Number,
      required: false,
      default: function () {
