...
const exerciseSchema = new mongoose.Schema({
  ...
  time: { type: Number },          // seconds, only for "time" type
  reps: { type: Number },          // only for "reps" type
  sets: { type: Number },
  notes: { type: String, trim: true },
  thumbnail: { type: String },      // URL/path to uploaded image
  section: {
    type: String,
...
const classSchema = new mongoose.Schema(
  {
    ...
    thumbnail: { type: String }, // Main program thumbnail URL
    ...
    duration: { type: String, trim: true }, // e.g., "30 – 45 min"
