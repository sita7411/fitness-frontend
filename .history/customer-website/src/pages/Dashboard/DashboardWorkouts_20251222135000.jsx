    ...
    try {
      ...
      if (res.data.success && !res.data.alreadyCompleted) {
        ...
        if (allCompleted) {
          ...
          // Automatically mark day as complete on backend (without HR/weight)
          try {
            ...
            // Fallback: abhi bhi popup dikhao taaki user manually save kar sake
          }

          setShowCompletePopup(true); // Optional: ab bhi dikha sakte ho feedback ke liye
        }
      }
    } catch (err) {
