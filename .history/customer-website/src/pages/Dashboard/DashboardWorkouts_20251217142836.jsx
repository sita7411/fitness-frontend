              ...
              <>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <button
                    ...
                    disabled={completedExercises.includes(exercises[currentIndex]?.id)}  // ← ये नया add करें
                    className={`py-3 rounded-full font-medium transition ${completedExercises.includes(exercises[currentIndex]?.id)
                  ...
                  >
                    {completedExercises.includes(exercises[currentIndex]?.id) ? 'Completed' : 'Mark Complete'}
                  </button>
