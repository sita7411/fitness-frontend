...
export default function NutritionPage() {
  ...
  useEffect(() => {
    ...
    const loadProgress = async () => {
      try {
        setProgressLoading(true);  // ← Loading start
        console.log("Loading progress for Plan:", selectedPlanId, "Day:", selectedDayIndex);
        ...
        console.log("Loaded completed meals:", completedIds);
        setCompletedMeals(completedIds);
      } catch (err) {
        console.error("Progress reload error:", err);
      } finally {
        setProgressLoading(false);  // ← Loading end
      }
    };
