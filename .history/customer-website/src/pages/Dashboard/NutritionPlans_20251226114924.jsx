...
useEffect(() => {
  const fetchInitialData = async () => {
    try {
      ...
      // ✅ Yeh 2 lines add karo — pehle day index set karo
      setSelectedDayIndex(0);  // Default day 0
      setCompletedMeals([]);   // Clear previous progress
