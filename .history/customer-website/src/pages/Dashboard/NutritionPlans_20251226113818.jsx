...
export default function NutritionPage() {
      ...
      try {
        ...
        if (userPlans.length > 0) {
          ...
          if (currentPlanProgress) {
            const completedIds = currentPlanProgress.completedMeals
              .filter(cm => cm.dayIndex === selectedDayIndex)  // ← Yeh line add karo
  ...
  useEffect(() => {
    ...
    loadProgress();
  }, [selectedPlanId, selectedDayIndex]);  // ← selectedDayIndex bhi dependency mein add karo
