...
const [lastWorkoutDate, setLastWorkoutDate] = useState(null);    const [reminderEnabled, setReminderEnabled] = useState(() => JSON.parse(localStorage.getItem('challengeReminderEnabled') || 'false'));
