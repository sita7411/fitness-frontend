...
export default function DashboardHome() {
  ...
  // Icon mapping for notifications (same as FitnessNotifications)
...
<div className="bg-white rounded-xl p-4" style={cardStyle}>
  ...
  {/* Fake realistic steps when no real data */}
  {const defaultSteps = Math.floor(7000 + Math.random() * 2500); // 7000–9500 random}
  {const displaySteps = todayStats.steps > 0 ? todayStats.steps : defaultSteps;}
