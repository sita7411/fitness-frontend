// DashboardHome.jsx → FINAL 100% WORKING VERSION
    ...
    const fetchAll = async () => {
      try {
        ...
        const [weeklyRes, todayRes, sessionRes, scheduleRes] = await Promise.all([
          ...
          axios.get("/api/stats/today", { headers }),
          axios.get("/api/stats/latest-session", { headers }),
          axios.get("/api/stats/today-schedule", { headers }),
        ]);
        ...
        // Today's Schedule — YEH ANDAR HONA CHAHIYE!
        ...
        // Sab fail ho jaaye toh fallback
        setTodaySchedule([]);
        setSessionLoading(false);
        setScheduleLoading(false);
      }
