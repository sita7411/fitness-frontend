              ...
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{
                    background:
                      item.icon === "workout"
                        ? THEME + "22"                    // Red for workout
                        : item.icon === "activity"
                          ? "#10b98122"                     // Green for activity/progress
                          : item.icon === "membership"
                            ? "#fbbf2422"                     // Golden yellow background for membership (amber-400)
                            : item.icon === "purchase"
                              ? "#3b82f622"                     // Blue background for purchases (blue-500)
                              : item.type === "error"
                                ? "#ff4d4f22"
                                : "#e5e7eb",
                    color:
