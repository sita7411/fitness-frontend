            ...
            >
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{
                    background:
                      item.icon === "workout" || item.icon === "activity"   // ← YAHAN "activity" add kiya
                        ? THEME + "22"                                    // Red background (#e3002a22)
                        : item.type === "error"
                          ? "#ff4d4f22"
                          : "#e5e7eb",                                      // Gray for others
                    color:
                      item.icon === "workout" || item.icon === "activity"   // ← YAHAN bhi
                        ? THEME                                           // Red icon color (#e3002a)
                        : item.type === "error"
                          ? "#ff4d4f"
