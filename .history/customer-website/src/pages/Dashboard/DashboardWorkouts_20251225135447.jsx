...
export default function MyWorkouts() {
      ...
      <AnimatePresence>
        {showCompletePopup && (
          ...
          >
           ...
           <div className="flex gap-3">
  {/* Skip Button – workout minutes save karega, HR/weight null */}
  <button
    onClick={async () => {
      const totalSeconds = calculateDayWorkoutSeconds();
      const workoutMinutes = Math.round(totalSeconds / 60);
      ...
      try {
        ...
        alert("Progress not saved. Please try again.");
      } finally {
        setHeartRate("");
        setWeightInput("");
  ...
  >
    Skip (Save Minutes Only)
  </button>

  {/* Save & Continue – sab kuch save karega */}
  <button
    onClick={async () => {
