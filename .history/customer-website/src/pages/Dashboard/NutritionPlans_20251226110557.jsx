  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const userProgress = userRes.data.user?.nutritionProgress || []; // ← Note: .user kyunki auth/me user object return karta hai
        ...
        if (currentPlanProgress) {
          const completedMealIds = currentPlanProgress.completedMeals.map(
            cm => cm.mealId.toString()
          );
