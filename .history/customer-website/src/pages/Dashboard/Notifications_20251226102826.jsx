              ...
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{
                    background:
                      item.icon === "workout"
                        ? THEME + "22"                  // Red background for workout (#e3002a22)
                        : item.icon === "activity"
                          ? "#10b98122"                   // Soft green background (#10b981 = emerald-500, +22 for opacity)
                          : item.type === "error"
                            ? "#ff4d4f22"
                            : "#e5e7eb",                    // Gray for others
                    color:
                      item.icon === "workout"
                        ? THEME                         // Red icon for workout
                        : item.icon === "activity"
                          ? "#10b981"                     // Green icon for activity
                          : item.type === "error"
                            ? "#ff4d4f"
                            : "#6b7280",
                  }}
