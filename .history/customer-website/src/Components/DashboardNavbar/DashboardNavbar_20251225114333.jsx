...
// Socket setup with better control
const socket = io("http://localhost:5000", {
  autoConnect: false, // Manual connect to avoid issues
...
export default function Navbar() {
  ...
  // Socket + Fetch logic (only when logged in)
  useEffect(() => {
    ...
    // Listen for new notifications (single listener)
    ...
    return () => {
      ...
      // Don't disconnect here if other components use same socket
    };
