...
import { getSocket } from "../../utils/socket"; // ← यही single socket use होगा
...
export default function Navbar() {
  ...
  // Fetch notifications + Socket listener
  useEffect(() => {
    if (loading || !isLoggedIn || !authUser?._id) return;

    let isMounted = true;
    const socket = getSocket(); // ← Single shared instance
    ...
    // Register user on socket (only if not already registered)
    const registerUser = () => {
